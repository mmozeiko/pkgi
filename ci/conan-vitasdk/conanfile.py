...
class VitasdkToolchainConan(ConanFile):
    ...
    def source(self):
        tools.download("https://github.com/blastrock/autobuilds/releases/download/master-linux-v7/vitasdk-x86_64-linux-gnu-2018-09-16_17-17-04.tar.bz2", filename="vitasdk.tar.bz2")
